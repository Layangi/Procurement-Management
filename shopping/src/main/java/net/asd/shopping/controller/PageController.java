...
public class PageController {
	...
	//supplier
	@RequestMapping(value = "/show/all/supplier")

	public ModelAndView viewSupplier() {

		ModelAndView mv = new ModelAndView("page");
		mv.addObject("title", "All Supplier");
		// Passing the list of categories
		mv.addObject("suppliers", supplierDAO.list());
		mv.addObject("userClickAllSuppliers", true);
		return mv;
	...
	public ModelAndView showAllItems() {
		...
		// Passing the list of categories
		mv.addObject("itemss", itemDAO.list());
	...
	public ModelAndView payment() {
		...
		logger.debug("Inside Psge Controller index Method - DEBUG");
		// Passing the list of categories
		mv.addObject("payment", paymentDAO.list());
